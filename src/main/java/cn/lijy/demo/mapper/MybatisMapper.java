...
public interface MybatisMapper {
     ...
     * @Time: 9:52
     **/
    @Select("SELECT user_name from SY_USER  where USER_ID ='1'")
    String findservName();
    ...
    @Insert("INSERT INTO SY_USER (USER_CODE, USER_LOGIN_NAME, USER_PASSWORD, USER_NAME) VALUES (#{userEntity.userCode},#{userEntity.userLoginName},#{userEntity.userPassword},#{userEntity.userName})")
    int addUserDate(@Param("userEntity") UserEntity userEntity);
